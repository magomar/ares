...
//        scheduledExecutorService = Executors.newScheduledThreadPool(5);
    ...
    public void tick() {
        ...
        if (tick == TICKS_PER_TURN) {
            tick = 0;
            turn++;
            Logger.getLogger(Clock.class.getName()).log(Level.INFO, "Turn: {0} - Time: {1}", new Object[]{turn, toString()});
        ...
        engine.update(new ClockEvent(this, eventTypes));
    }
