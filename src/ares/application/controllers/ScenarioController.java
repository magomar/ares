...
public final class ScenarioController {
    ...
    private final ScenarioInteractor coordinator;

    public ScenarioController(ScenarioInteractor coordinator) {
        ...
        Action[] mainActions = {open, load, settings, exit};
        close.setEnabled(false);
        coordinator.addMainActions(mainActions);
    ...
    private class OpenScenarioActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                Container container = coordinator.getGUIContainer();
...
//                Container container = boardView.getContentPane();
                ...
                coordinator.newScenario(scenario);
            }
        }
    }
