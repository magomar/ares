...
public class UnitsLayer extends AbstractImageLayer {
     ...
     */
    private EnumMap<UnitColor, SoftReference<BufferedImage>> unitBufferMap = new EnumMap<>(UnitColor.class);
    /**
     ...
     * @see UnitColor
     */
    private void loadUnitGraphics(UnitColor uc) {
