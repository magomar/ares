...
public final class ForceModel extends RoleMediatedModel {
    ...
    public TreeModel getTreeModel() {
        ...
        for (Formation formation : force.getFormations()) {
            ...
            if (hq != null) {
                ImageProvider unitImageProvider = GraphicsModel.INSTANCE.getImageProviders(1).get(hq.getColor());
        ...
        for (Unit unit : force.getActiveUnits()) {
            ImageProvider unitImageProvider = GraphicsModel.INSTANCE.getImageProviders(1).get(unit.getColor());
