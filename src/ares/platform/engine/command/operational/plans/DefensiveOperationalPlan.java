...
class DefensiveOperationalPlan extends OperationalPlan {
    ...
    public DefensiveOperationalPlan(Formation formation, List<Objective> objectives, Emphasis emphasis, SupportScope supportScope, ActionSpace actionSpace) {
        super(OperationalStance.DEFENSIVE, formation, objectives, emphasis, supportScope, actionSpace);
    }
