...
class OffensiveOperationalPlan extends OperationalPlan {
    ...
    public OffensiveOperationalPlan(Formation formation, List<Objective> objectives, Emphasis emphasis, SupportScope supportScope, ActionSpace actionSpace) {
        super(OperationalStance.OFFENSIVE, formation, objectives, emphasis, supportScope, actionSpace);
    }
